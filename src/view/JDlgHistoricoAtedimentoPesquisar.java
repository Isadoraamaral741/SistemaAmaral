...
public class JDlgHistoricoAtedimentoPesquisar extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgHistoricoAtedimentoPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgHistoricoAtedimentoPesquisar dialog = new JDlgHistoricoAtedimentoPesquisar(new javax.swing.JFrame(), true);
